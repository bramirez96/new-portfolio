...
import { Link, LinkTypes } from './links';
import { ArrayResponse } from './other';
...
export type Entry<
	EntryType extends EntryTypes = EntryTypes,
...
export default class Entries extends _BaseContentfulAPI {
	 ...
	 */
	public static getByID<EntryType>(
		entryID: string,
	): Promise<EntryType> {
