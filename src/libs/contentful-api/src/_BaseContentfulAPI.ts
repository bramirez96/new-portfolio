...
import { ContentfulAPIFetchOptions } from './other';

export default class _BaseContentfulAPI extends API {
	// private static ORG_ID = import.meta.env.CONTENTFUL_API_ORG_ID;
	private static SPACE_ID = process.env.CONTENTFUL_API_SPACE_ID;
	private static ACCESS_TOKEN = process.env.CONTENTFUL_API_ACCESS_TOKEN;
	private static ENVIRONMENT = process.env.CONTENTFUL_API_ENVIRONMENT;
	protected static BASE_URL = process.env.CONTENTFUL_API_BASE_URL as string;
	...
	>(
		...
		return super._Get<BodyType, ParamType, ResponseType>(path, apiFetchOpts);
	}
	...
	>(
		...
		return super._Post<BodyType, ParamType, ResponseType>(path, body, apiFetchOpts);
	}
	...
	>(
		...
		return super._Put<BodyType, ParamType, ResponseType>(path, body, apiFetchOpts);
	}
	...
	>(
		...
		return super._Delete<BodyType, ParamType, ResponseType>(path, apiFetchOpts);
	}
}
